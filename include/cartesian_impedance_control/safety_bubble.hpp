...
class SafetyBubble : public rclcpp::Node, public cartesian_impedance_control::CartesianImpedanceController {
    ...
    void external_force(const sensor_msgs::msg::JointState current_joint_state_,const geometry_msgs::msg::PoseStamped inital_position_, const geometry_msgs::msg::PoseStamped current_position_); //Initializes the function, which calculates the external force
    ...
    int R = 0.2; //Outer Radius of the Safety Bubble [m]
    ...
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr f_ext_publisher_; //initalized the publisher for the external force
    rclcpp::Publisher<messages_fr3::msg::SetPose>::SharedPtr goal_publisher_; //initalized the publisher for the new goal in case of follow and hold
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr hold_stiffness_publisher_;
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr P_publisher_;
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr D_h_publisher_;
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr offset_publisher_;

    rclcpp::Subscription<messages_fr3::msg::SetPose>::SharedPtr test_hand_position_subscriber_; //initalized the subscriber used to include the test hand position    

    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr test_results_publisher_;
    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr test_end_publisher_;
    ...
    int alpha; //ration between starting position and goal position
